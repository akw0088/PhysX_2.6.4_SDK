...
For example it searches the TrainingPrograms\Media directory on the PC (assuming the exe is in the bin directory or
or project directory after a compile). This helps prevent duplicate resources for training programs.
